...
//    }
    ...
    fun checkNumInRange(num: Int): String {
       return when{
            num in -99 .. 0 -> "Число $num принадлежит интервалу (-100; 0]"
            num in 1 .. 3 -> "Число $num принадлежит интервалу (0; 3]"
            num in 4 .. 100 -> "Число $num принадлежит интервалу (3; 100]"
            num in 101 .. 102 -> "Число $num принадлежит интервалу (100; 102]"
